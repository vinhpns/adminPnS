                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <button type="button" style="font-size: 20px; width: 200px; margin-left: 25px; margin-top: 25px;" 
                                            class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Thêm Video
                                    </button>
                                            ...
                                            <form action="video.htm" method="post" modelAttribute="video" class="form-horizontal"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header" style="display: inline">
                                                        ...
                                                        <h3 class="modal-title">Thêm Video</h3>
                                                    </div>
                                                    <div class="modal-body">
                                                    <%@include file="video/insert-modal.jsp" %>
                                                </div>
