        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Phiên Đang Đấu</li>
                </ul><!-- /.breadcrumb -->
            </div>
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Phiên Đang Đấu</h3>
                                <div class="clearfix">
                                    <div class="pull-right tableTools-container"></div>
                                </div>
                                <div class="table-header">
                                    Danh Sách Các Phiên Đang Đấu
                                </div>
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hidden-480">Lịch Sử Đấu</th>
                                            <th>Thao Tác</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="bidProduct" items="${bidProducts}" varStatus="counter">
                                            <tr>
                                                <td class="center hidden-480">${counter.index + 1}</td>
                                                <td class="hidden-480">${bidProduct.ordercode}</td>
                                                <td>${bidProduct.name}</td>
                                                <td class="hidden-480">
                                                    <span class="label label-sm label-info arrowed arrowed-righ">Đang Đấu</span>
                                                </td>
                                                <td class="hidden-480">
                                                    <a class="green" href="hisend.htm?getHistory&id=${bidProduct.id}">
                                                        <i class="ace-icon fa fa-angle-double-down bigger-130"
                                                           data-target="#modal-table-edit${ind}" data-toggle="modal">
                                                        </i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        <a class="green" href="SaleBid.htm?get&id=${bidProduct.id}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"
                                                               data-target="#modal-table-edit${ind}"
                                                               data-toggle="modal">
                                                            </i>
                                                        </a>
                                                        <a class="red" href="ListBidding.htm?delete&id=${bidProduct.id}"
                                                           onclick="return confirm('Bạn có muốn huỷ phiên này không ?')"
                                                           href="">
                                                    ...
                                                    <div class="hidden-md hidden-lg">
                                                        <div class="inline pos-rel">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                                <li>
                                                                    <a class="green"
                                                                       href="SaleBid.htm?get&id=${bidProduct.id}">
                                                                        <i class="ace-icon fa fa-pencil bigger-130"
                                                                           data-target="#modal-table-edit${ind}"
                                                                           data-toggle="modal">
                                                                        </i>
...
<script>
    $('#modal-table-edit').on('show.bs.modal', function (event) {
