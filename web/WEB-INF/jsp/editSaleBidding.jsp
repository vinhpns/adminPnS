                        ...
                        <div class="modal-body no-padding">
                            <div class="row">
                                <div class="col-xs-12" style="margin-left: 10px">
                                    <!-- PAGE CONTENT BEGINS -->
                                    <form action="SaleBid.htm" method="POST" class="form-horizontal"
                                          modelAttribute="bidProduct" role="form" enctype="multipart/form-data">
                                        <div hidden="" class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                                ID </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.id}" name="id" type="text" id="form-field-1"
                                        ...
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right roomId"
                                                   for="form-field-1"> Phòng đăng </label>
                                            <div class="col-sm-9">
                                                <select id="form-field-1" class="col-xs-10 col-sm-5 roomId"
                                                        name="roomId" style="width:300px;">
                                                    <c:forEach var="r" items="${idroom}">
                                                        <option  ${r.id == bidProduct.roomId ? 'selected' : ''}
                                                                value="${r.id}">${r.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group" hidden="">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.createdBy}" name="createdBy" type="text"
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right name"
                                                   for="form-field-1"> Tên sản phẩm </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.name}" name="name" type="text"
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">
                                                Gía ban đầu </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.initalMoney}" name="initalMoney"
                                                       type="number" style="width:300px;" min="1" id="form-field-1-1"
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">
                                                Bước giá </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.priceStep}" name="priceStep" type="number"
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">
                                                Màu Sắc </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.color}" name="color" type="text"
                                                       style="width:300px;" id="form-field-2" placeholder="Màu Sắc"
                                                       class="col-xs-10 col-sm-5 priceStep"/>
                                            </div>
                                        </div>
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">
                                                Năm Sản Xuất </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.year}" name="year" type="number"
                                                       style="width:300px;" min="1" max="2019" id="form-field-2"
                                                       placeholder="Năm Sản Xuất" class="col-xs-10 col-sm-5 priceStep"/>
                                            </div>
                                        </div>
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">
                                                Bảo Hành </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.warranty}" name="warranty" type="text"
                                                       style="width:300px;" min="1" max="2019" id="form-field-2"
                                                       placeholder="Bảo Hành" class="col-xs-10 col-sm-5 priceStep"/>
                                            </div>
                                        </div>
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">
                                                Tình Trạng </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.situation}" name="situation" type="text"
                                                       style="width:300px;" min="1" max="99" id="form-field-2"
                                                       placeholder="Tình Trạng" class="col-xs-10 col-sm-5 priceStep"/>
                                            </div>
                                        </div>
                                        <div class="space-4"></div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">
                                                Trạng thái </label>
                                            <div class="col-sm-9">
                                                <input value="${bidProduct.status}" name="status" type="number"
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                                Hình ảnh </label>
                                            <div class="col-sm-9">
                                                <img src="${bidProduct.image}" style="width:300px;height:300px"
                                                     id="pic1"/>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                                Hình ảnh 2</label>
                                            <div class="col-sm-9">
                                                <img src="${bidProduct.img1}" style="width:300px;height:300px"
                                                     id="pic2"/>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                                Hình ảnh 3</label>
                                            <div class="col-sm-9">
                                                <img src="${bidProduct.img2}" style="width:300px;height:300px"
                                                     id="pic3"/>
                                                <input value="" id="file-input" type="file" style="width:300px;"
                                        ...
                                        <div class="space-4"></div>
                                        <input value="${bidProduct.isDel}" name="isDel" class="col-xs-1 isDel"
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-offset-7 col-md-5" style="text-align: center">
                                            <a href="ListBidding.htm"
                                               onclick="return confirm('Thao tác vẫn chưa được lưu')" href="">
