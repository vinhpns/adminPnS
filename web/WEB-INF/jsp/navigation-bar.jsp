<%-- 
    ...
    Created on : Dec 1, 2019, 12:24:48 PM
    Author     : SGDG Company
--%>
    ...
    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        ...
        <form class="form-inline ml-3">
            <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar" type="search" placeholder="Gõ tiêu đề bài viết cần tìm" aria-label="Search">
                    ...
                    <a href="#" class="dropdown-item">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-sm">${sessionScope.commentNotRead}</p>
                            </div>
                        </div>
                    </a>
