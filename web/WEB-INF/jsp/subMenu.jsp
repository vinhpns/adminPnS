                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Danh sách các mục SubMenu</h3>
                                    </div>
                                    <button type="button" style="font-size: 20px; width: 200px; margin-left: 25px; margin-top: 25px;" 
                                            class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Thêm SubMenu
                                    </button>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <form action="menu.htm" method="post" modelAttribute="ban" class="form-horizontal"
                                                ...
                                                <div class="modal-footer">
                                                    <button class="btn btn-primary btn-lg" type="submit" name="insertSubMenu">Cập Nhật</button>
                                ...
                                <div class="card-body">
                                    <%@include file="submenu/table.jsp" %>
                                </div>
                            </div>
                        </div>
                    </div>
