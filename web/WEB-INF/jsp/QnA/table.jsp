            ...
            <c:forEach var="news" items="${news}" varStatus="counter">
                ...
                <td class="text-center hidden-480">
                    <span class="status_active">
                        <c:if test="${news.active == true}">
                            <a href="ListNews.htm?lock&id=${news.id}&status=${news.active}">
                ...
                <td>
                    <div class="hidden-sm hidden-xs action-buttons">
                        ...
                        <a class="red" href="ListNews.htm?delete&id=${news.id}"
                ...
                <div class="modal fade" id="myModalUpadte_${news.id}" role="dialog">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <form action="ListNews.htm" method="post" modelAttribute="ban" class="form-horizontal"
