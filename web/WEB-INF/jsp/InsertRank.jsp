        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Đăng danh hiệu hiệu</li>
                </ul><!-- /.breadcrumb -->
            </div>
                        ...
                        <form action="RankList.htm" method="post" class="form-horizontal" role="form"
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <div>
                                                ...
                                                <input type="number" required="" id="form-field-11"
                                                       placeholder="Nhập điểm số"
                                                       class="autosize-transition form-control" name="requiredPoint"
                                                       style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 40px;">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <button style="float: right; border-radius: 10px" class="btn btn-primary btn-lg"
                                        type="submit" name="insertRank">Thêm Mới
                                </button>
                            </div>
                            <div>
                                <button style="border-radius: 10px" type="reset" value="Reset"
                                        class="btn btn-primary btn-lg">Nhập Lại
                                </button>
                            </div>
                        </form>
                    </div><!-- /.modal-content -->
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $('#id-input-file-1 , #id-input-file-2, #id-input-file-4, #id-input-file-5').ace_file_input({
            no_file: 'No File ...',
            btn_choose: 'Choose',
            btn_change: 'Change',
            droppable: false,
